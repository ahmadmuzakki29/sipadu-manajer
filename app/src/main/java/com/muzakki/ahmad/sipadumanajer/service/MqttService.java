...
import com.muzakki.ahmad.sipadumanajer.main.Receiver;
...
public class MqttService extends Service implements MqttTraceHandler {
    ...
    static final String TAG = "MqttServiceSipaduManajer";
    ...
    public void disconnect(String clientHandle, String invocationContext,
        ...
        // the activity has finished using us, so we can stop the com.muzakki.ahmad.sipadumanajer.service
        // the activities are bound with BIND_AUTO_CREATE, so the com.muzakki.ahmad.sipadumanajer.service will
     ...
     * @param qos
     *            the quality of com.muzakki.ahmad.sipadumanajer.service requested
     * @param retained
     ...
     * @param qos
     *            requested quality of com.muzakki.ahmad.sipadumanajer.service for the topic
     * @param invocationContext
     *            arbitrary data to be passed back to the application
     * @param activityToken
     *            arbitrary identifier to be passed back to the Activity
     ...
     * @param qos
     *            requested quality of com.muzakki.ahmad.sipadumanajer.service for each topic
     * @param invocationContext
     *            arbitrary data to be passed back to the application
     * @param activityToken
     *            arbitrary identifier to be passed back to the Activity
...
//        traceCallback(MqttServiceConstants.TRACE_DEBUG, tag, message);
    ...
    public void callbackToReceiver(String payload) {
    ...
    /**
     * @return whether the android com.muzakki.ahmad.sipadumanajer.service can be regarded as online
     */
