...
// {response:'OK',token:'3wew45'}
    ...
    public void login(View v){
        String url = Constants.getHost()+"/login/";
        if(ip==null){
        ...
        params.put("username",((EditText) findViewById(R.id.txtUsername)).getText().toString());
    ...
    private void loginSuccess(String token){
        db.clearCache();
        String nosambungan = ((EditText) findViewById(R.id.txtUsername)).getText().toString();
        Constants.setUsername(nosambungan);
