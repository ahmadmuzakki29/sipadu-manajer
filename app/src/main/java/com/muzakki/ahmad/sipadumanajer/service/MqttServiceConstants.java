 ...
 * com.muzakki.ahmad.sipadumanajer.service, mainly used in Intents passed between Activities and the Service.
 */
public interface MqttServiceConstants {
	...
	static final String VERSION = "manajer";
  ...
  static final String CALLBACK_MESSAGE_ID = MqttService.TAG + '.'
                                            + MESSAGE_ID;
  static final String CALLBACK_MESSAGE = MqttService.TAG + ".MESSAGE";
